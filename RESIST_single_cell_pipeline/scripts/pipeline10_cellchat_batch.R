...
###
source("/blue/qsong1/sen.guo/resist_02/resist_spatial/scripts/netVisual_bubble.R") ## modified function to remove NAs
...
outdir <- '/blue/qsong1/sen.guo/resist_02/resist_spatial/results'
if (!dir.exists(outdir)) {
  dir.create(outdir, recursive = TRUE)
}
rds_files <- list.files('/blue/qsong1/sen.guo/resist_02/resist_spatial/data', pattern = "\\.rds$", full.names = TRUE, ignore.case = TRUE)
...
p_sens <- plot_circle(cellchat.sens, "Sensitive")
p_res  <- plot_circle(cellchat.res,  "Resistant")
