...
# C5_annotate_variants.py
# -----------------------------------------------------------------------------
# Purpose  : Annotate each significant locus against dbSNP and ClinVar, attaching the
#            rsID, gene, functional consequence and clinical significance that the
#            RESIST browser displays alongside the variant heatmap.
# Inputs   : input.csv - columns Chr, Pos (from C4)
# Outputs  : annotated_output.csv
# Usage    : python C5_annotate_variants.py input.csv annotated_output.csv
# Origin   : Variant_detection/mutation_annotation.py
# Notes    : Queries public annotation services; needs network access.
# =============================================================================
