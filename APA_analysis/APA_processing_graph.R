...
## -----------------------------------------------------------------------------
# gff_path: Path to the custom UTROME GTF file used for PAS coordinate mapping
gff_path <- "/home/scUTRquant/extdata/targets/utrome_hg38_v1/utrome.e30.t5.gc39.pas3.f0.9999.w500.gtf"

# annotation_seurat_path: Reference Seurat object containing cell-type metadata
annotation_seurat_path <- "/home/data/scUTRquant/GSE131984_JQ1Pal_seurat_afterAnno.RData"

# Output directory structure
OUTDIR   <- "GSE131984_JQ1Pal_mixed"
...
## 2. SAMPLE DEFINITION
## -----------------------------------------------------------------------------
# Define mapping between 10x matrix directories and scUTRquant TXS RDS files
sample_tbl <- tibble::tribble(
  ~sample_id, ~group,   ~tenx_dir,                                                                                                      ~txs_rds,
  "mixed1",   "Mixed",  "/home/GSE131984-result/GSM3833410-1/outs/filtered_feature_bc_matrix",
  "/home/data/scUTRquant/result1/GSE131984-group5-sensitive-1/sce/utrome_hg38_v1/GSE131984.txs.Rds",
  "mixed2",   "Mixed",  "/home/GSE131984-result/GSM3833416-1/outs/filtered_feature_bc_matrix",
  "/home//data/scUTRquant/result1/GSE131984-group3-resistant-1/sce/utrome_hg38_v1/GSE131984.txs.Rds"
)
...
for (i in seq_len(nrow(sample_tbl))) {
  ...
  tenx_dir <- sample_tbl$tenx_dir[i]
  txs_rds  <- sample_tbl$txs_rds[i]
